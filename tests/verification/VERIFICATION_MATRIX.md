...
| 9c | 84-95% of the provider-bound floor (deterministic 40ms stub; floor 55% for CI-runner noise) | test_verify_performance.py | test_claim_scheduling_stays_close_to_the_theoretical_floor |
